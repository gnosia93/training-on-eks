...
sed -i 's/127.0.0.1/0.0.0.0/g' /home/ec2-user/.config/code-server/config.yaml && sed -i 's/auth: password/auth: none/g' /home/ec2-user/.config/code-server/config.yaml
EC2_USER_SCRIPT
