...
* C5. 가시성(Observability) 및 메트릭 분석 
   ...
   * [DCGM DeepDive](https://github.com/gnosia93/training-on-eks/blob/main/chapter/deepdive/d1.dcgm-deepdive.md)
...
* 2025-01-08 Intel AMX - Gloo 기반 CPU 분산 훈련 추가
