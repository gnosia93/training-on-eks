...
* C5. Observability 
   ...
   * [c5-2. EFA 네트워크 모니터링](https://github.com/gnosia93/training-on-eks/blob/main/chapter/c5-network-efa-mon.md) 
   * [C5-3. 훈련 로그 수집](https://github.com/gnosia93/training-on-eks/blob/main/chapter/c5-log-monitoring.md)
   * [C5-4. 연산 속도가 느린 GPU / 네트워크 카드 / 노드 식별](https://github.com/gnosia93/training-on-eks/blob/main/chapter/c8-detect-perf-drop.md)
...
* C7. 분산 훈련 최적화
   ...
   - [NCCL 토플로지](https://github.com/gnosia93/training-on-eks/blob/main/chapter/c7-training-optimization-nccl.md) 
   - [Placement Group](https://github.com/gnosia93/training-on-eks/blob/main/chapter/c7-placement-nccl.md)
