...
_EKS 및 Kubeflow(PytorchJob, Trainer) 를 활용하여 대규모 모델을 분산 훈련하고 모니터링 하는데 필요한 기술에 대해서 다룬다. GPU 인스턴스는 Karpenter Nodepool 을 이용하여 프러비저닝 하고, 모니터링 스택은 Prometheus / Grafana 스택을 활용한다._ 
