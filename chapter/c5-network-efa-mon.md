...
Grafana "Import" 메뉴에서 아래 대시보드를 임포트 한다. 이때 데이터 소스는 Prometheus를 선택한다.
* NVIDIA DCGM Exporter (ID: 12239): GPU 사용률, 메모리, 온도와 함께 EFA 성능을 통합 관리하기에 가장 좋습니다.
* Node Exporter Full (ID: 1860): 전체 네트워크 인터페이스(RDMA 포함) 성능을 상세히 볼 수 있습니다.
