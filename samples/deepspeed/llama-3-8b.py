...
# ZeRO-3는 이 설정을 통해 모델을 로드하면서 즉시 GPU들에 분산시킵니다.
...
training_args = TrainingArguments(
    ...
    logging_steps=10,
    deepspeed="ds_config_stage3.json", # 위에서 만든 설정 파일 연결
    save_strategy="epoch",
    gradient_checkpointing=True,   # 메모리 절약을 위한 재계산(FlashAttention과 유사한 개념)
)
