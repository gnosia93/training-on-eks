...
* 1 Pod [4 GPU / 4 EFA] - 0:38:32 (via SHM/direct/direct)
* 4 Pod [1 GPU / 1 EFA] - 2:09:40 (via NET/Libfabric/0) ---> RDMA       
* 4 Pod [1 GPU / 1 ENI] - (n/a)       

#### p4d.24xlarge 1대 (A100) ####
* 1 Pod [4 GPU / 4 EFA] - 0:16:21 ( via P2P/CUMEM/read, P2P Type isAllDirectP2p 1 directMode 0)
* 4 Pod [1 GPU / 1 EFA] - 0:39:32 ( via NET/Libfabric/0/GDRDMA )  ---> GPU Direct RDMA        
* 4 Pod [1 GPU / 1 ENI] - 1:20:29 ( via NET/Socket/0 )        

#### p5.48xlarge 1대 (H100) #### <--- 다시 테스트 필요.
